...
public class xAuthCustomCommandTabCompletion extends xAuthCommandTabCompletion {
    ...
    public xAuthCustomCommandTabCompletion(CommandSender sender, Command command, String alias, String[] args) {
        super(sender, command, alias, args);
    }

    public void setArguments(List<String> customArguments) {
        this.arguments = customArguments;
    }
