...
public class xAuthPlayerInteractEntityEvent extends xAuthEvent {
    ...
    public xAuthPlayerInteractEntityEvent(xAuthEventProperties properties) {
        super(properties);
    }
    ...
    public String getInteractWithEntity() {
        return (String) this.getProperty("interactwithentity");
    }
