 ...
 * @author lycano
 */
public class xAuthCommandAdminLogoutEvent extends xAuthEvent {

    private static final HandlerList handlers = new HandlerList();

    public xAuthCommandAdminLogoutEvent(xAuthEventProperties properties) {
        super(properties);
    }
    ...
    public enum Action {
        SUCCESS_LOGOUT_PLAYER, ERROR_GENERAL, ERROR_LOGOUT_AUTHENTICATED
    }
}
