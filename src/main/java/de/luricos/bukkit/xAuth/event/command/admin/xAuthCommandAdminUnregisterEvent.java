 ...
 * @author lycano
 */
public class xAuthCommandAdminUnregisterEvent extends xAuthEvent {

    private static final HandlerList handlers = new HandlerList();

    public xAuthCommandAdminUnregisterEvent(xAuthEventProperties properties) {
        super(properties);
    }
    ...
    public enum Action {
        SUCCESS_UNREGISTER, ERROR_GENERAL, ERROR_REGISTERED
    }
}
