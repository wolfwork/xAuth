 ...
 * @author lycano
 */
public class xAuthCommandAdminLockEvent extends xAuthEvent {

    private static final HandlerList handlers = new HandlerList();

    public xAuthCommandAdminLockEvent(xAuthEventProperties properties) {
        super(properties);
    }
    ...
    public enum Action {
        ERROR_LOCK_ALL, ERROR_REGISTERED, ERROR_LOCKED, SUCCESS_LOCK_PLAYER, SUCCESS_LOCKED_ALL
    }
}
