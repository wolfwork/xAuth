 ...
 * @author lycano
 */
public class xAuthCommandAdminUpdateEvent extends xAuthEvent {

    private static final HandlerList handlers = new HandlerList();

    public xAuthCommandAdminUpdateEvent(xAuthEventProperties properties) {
        super(properties);
    }
    ...
    public Updater.UpdateResult getUpdateResult() {
        return (Updater.UpdateResult) this.getProperty("updateresult");
    }

    public String getUpdateResultMessages() {
        return (String) this.getProperty("updateresultmessages");
    }
