 ...
 */
package de.luricos.bukkit.xAuth.event.entity;
...
public class xAuthEntityTargetEvent extends xAuthEvent {
    ...
    public xAuthEntityTargetEvent(xAuthEventProperties properties) {
        super(properties);
    }
    ...
    public EntityTargetEvent.TargetReason getReason() {
        return (EntityTargetEvent.TargetReason) this.getProperty("reason");
    }
