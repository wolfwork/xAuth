...
public enum PlayerPermissionCategory {
    ...
    private final static Map<Class<? extends Entity>, PlayerPermissionCategory> map = new HashMap<Class<? extends Entity>, PlayerPermissionCategory>();

    static {
        for (PlayerPermissionCategory cat : PlayerPermissionCategory.values()) {
    ...
    private PlayerPermissionCategory(String name, Class<? extends Entity>... classes) {
        this.name = name;
