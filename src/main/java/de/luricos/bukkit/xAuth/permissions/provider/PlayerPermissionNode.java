...
public abstract class PlayerPermissionNode {
    ...
    public PlayerPermissionNode(final String message) {
    ...
    public String getPermissionNode() {
        xAuthLog.fine("Requested PermissionNode: " + permissionNode);
        return permissionNode;
    }

    public String getEventType() {
        xAuthLog.fine("Requested EventType: " + eventType);
        return eventType;
    }

    public String getAction() {
        xAuthLog.fine("Requested EventAction: " + eventAction);
        return eventAction;
    }

    public String getEventName() {
        xAuthLog.fine("Requested EventName: " + eventName);
        return eventName;
    }
    ...
    private String getEntityName(Entity entity) {
        ...
        PlayerPermissionCategory category = PlayerPermissionCategory.fromEntity(entity);
